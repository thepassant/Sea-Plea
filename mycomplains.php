...
<div class="main_bg"><!-- start main -->
	...
	<div class="technology row">
       <h2><img src="<?=$editrow['image']?>"  height="100" width="100">
            <?=$editrow['name']?> <?=$editrow['Lname']?></h2>
	...
	<h2>My Complains</h2>
	 <?php
       ...
       $complainsresults = $conn->query("SELECT * from complain WHERE complain.complainID =".$complainidrow["complainID"]."");
		...
		echo " <li><a  href='mycomplainsItem.php?compid=".$complainrow["complainID"]."''>".$complainrow["complainSubject"]."</li></a>".$complainrow["complainTime"]."<br>";
