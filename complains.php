...
<html>
<head>
<title>BIS Academy | Complains </title>
<?php 
session_start();
?>
<!-- Bootstrap -->
...
<div class="footer_bg"><!-- start footer -->
	<div class="container">
		...
		<form class="form-horizontal" action="Codes/complains.php" method="post" enctype="multipart/form-data" >
		  <div class="panel-body">
          
                                <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Complain Subject</label>
                                ...
                                <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">receipt image</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                ...
                                <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Complain Details</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
		...
		<div class="form-group">
            <input class="btn btn-primary" type="submit" value="Submit Complain" >
        </div>
		</form>
		</div>
	</div>
